  ...
  { -- Useful plugin to show you pending keybinds.
    ...
    opts = {
      ...
      spec = {
        ...
        { '<leader>g', group = '[G]it' },
        -- Git helpers
        { '<leader>gd', desc = 'Git: Open Diffview' },
        { '<leader>gD', desc = 'Git: Close Diffview' },
        { '<leader>gfh', desc = 'Git: File history (current file)' },
        { '<leader>gFH', desc = 'Git: File history (repo)' },
        { '<leader>gy', desc = 'Git: Copy permalink (line/selection)', mode = { 'n', 'v' } },
        { '<leader>gco', desc = 'Git: Choose Ours (conflict)' },
        { '<leader>gct', desc = 'Git: Choose Theirs (conflict)' },
        { '<leader>gcb', desc = 'Git: Choose Both (conflict)' },
        { '<leader>gc0', desc = 'Git: Choose None (conflict)' },
        { '<leader>gcn', desc = 'Git: Next conflict' },
        { '<leader>gcp', desc = 'Git: Previous conflict' },
